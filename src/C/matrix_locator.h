...
const struct vector* feed_forward(const struct vector**, const struct vector*, const struct AI*);
const struct vector** back_propogation(const struct vector*, const struct AI*);
void adding_deltas(const struct matrix**, const struct vector*, const struct vector**, const struct vector**, const struct vector*, const struct vector*, const struct AI*);
